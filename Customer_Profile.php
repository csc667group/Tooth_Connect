...
<body>
    ...
    <!-- the tabs -->
        ...
        <!-- /row -->
            <div class="row">
                <div class="col-md-6">
                    <h3 class="">Tabs -left</h3>

                <!-- tabs left -->
                        <div class="tabbable tabs-left">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#a" data-toggle="tab" class="" contenteditable="false">One</a>
                                </li>
                                <li class=""><a href="#b" data-toggle="tab" class="" contenteditable="false">Two</a>
                                </li>
                                <li class=""><a href="#c" data-toggle="tab" class="" contenteditable="false">Twee</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="b">Secondo sed ac orci quis tortor imperdiet venenatis. Duis elementum auctor
